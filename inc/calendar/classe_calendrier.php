...
*/
		public function __construct($a_name="")
		{
			...
			//replace jours
			$this->days = array( __("Sunday",'ifserbie'), __("Monday",'ifserbie'), __("Tuesday",'ifserbie'), __("Wednesday",'ifserbie'), __("Thursday",'ifserbie'), __("Friday",'ifserbie'), __("Saturday",'ifserbie'),  __("Sunday",'ifserbie') );
      //replace joursC
			$this->daysC = array( __("Sun.",'ifserbie'), __("Mon.",'ifserbie'), __("Tue.",'ifserbie'), __("Wed.",'ifserbie'), __("Thu.",'ifserbie'), __("Fri.",'ifserbie'), __("Sat.",'ifserbie'), __("Sun.",'ifserbie') );
			//replace mois
			$this->month = array( 1 => __("January",'ifserbie'), 2 => __("February",'ifserbie'), 3 => __("March",'ifserbie'), 4 => __("April",'ifserbie'), 5 => __("May",'ifserbie'), 6 => __("June",'ifserbie'), 7 => __("July",'ifserbie'), 8 => __("August",'ifserbie'), 9 => __("September",'ifserbie'), 10 => __("October",'ifserbie'), 11 => __("November",'ifserbie'), 12 => __("December",'ifserbie') );
			//replace moisC
			$this->monthC = array( 1 => __("Jan.",'ifserbie'), 2 => __("Feb.",'ifserbie'), 3 => __("Mar.",'ifserbie'), 4 => __("Apr.",'ifserbie'), 5 => __("May",'ifserbie'), 6 => __("Jun.",'ifserbie'), 7 => __("Jul.",'ifserbie'), 8 => __("Aug.",'ifserbie'), 9 => __("Sep.",'ifserbie'), 10 => __("Oct.",'ifserbie'), 11 => __("Nov.",'ifserbie'), 12 => __("Dec.",'ifserbie') );
