...
*/
		protected $jours = array(
			...
			'SR' => array(0=>"Nedelja",1=>"Ponedeljak",2=>"Utorak",3=>"Sreda",4=>"Četvrtak",5=>"Petak",6=>"Subota",7=>"Nedelja"),
		...
		protected $joursC = array(
			...
			'SR' => array(0=>"Ned.",1=>"Pon.",2=>"Uto.",3=>"Sre.",4=>"Čet.",5=>"Pet.",6=>"Sub.",7=>"Ned."),
		...
		protected $mois = array(
			...
			'SR' => array(1=>"Januar",2=>"Februar",3=>"Mart",4=>"April",5=>"Maj",6=>"Jun",7=>"Jul",8=>"Avgust",9=>"Septembar",10=>"Oktobar",11=>"Novembar",12=>"Decembar"),
		...
		protected $moisC = array(
			...
			'SR' => array(1=>"Jan.",2=>"Feb.",3=>"Mar.",4=>"Apr.",5=>"Maj",6=>"Jun",7=>"Jul",8=>"Avg.",9=>"Sep.",10=>"Okt.",11=>"Nov.",12=>"Dec."),
...
*/
		public function _getInfosDate($a_date="") {
			...
			$patternSr = "/^(nedelja|ned|ponedeljak|pon|utorak|uto|sreda|sre|četvrtak|čet|petak|pet|subota|sub)?";
			$patternSr .= "[[:space:]]*([\d]{1,2})";
			$patternSr .= "[[:space:]]*(januar|jan|frebruar|feb|mart|mar|april|apr|maj|maj|jun|jun|jul|jul|avgust|avg|septembar|sep|oktobar|okt|novembar|nov|decembar|dec)";
			$patternSr .= "[[:space:]]*([\d]{2,4})";
			$patternSr .= "[[:space:]]?([\d]{2}:[\d]{2}(:[\d]{2})*)?";
			$patternSr .= "$/i";
			...
			// HR 					Ponedjeljak 11 kolovoz 2008 14:18:58
		 	 ...
		 	 // SR 					Ponedeljak 11 avgust 2008 14:18:58
  		else if (preg_match($patternSr,$date,$l_date)) {
				$res['format'] = "SR";
				$res['annee'] = $l_date[4];
				$res['mois'] = $this->_month2Num($l_date[3]);
				$res['jour'] = $l_date[2];
